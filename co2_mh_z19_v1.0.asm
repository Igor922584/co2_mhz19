...
; 10.2. Скорректировать обработку флагов (запрос/получение данных от LPS331AP в период ожидания
;       окончания преобразования значения температуры датчиком DS18B20).
; 10.3. Проверить обмен данными по TWI в части состояния сигналов на линиях SDA и SCL при 
